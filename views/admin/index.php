...
?>   
    ...
    <div class="col-md-6 col-lg-3">
        <div class="card">
            <div class="card-body p-0 clearfix">
                <i class="fab fa-product-hunt bg-info p-4 font-2xl mr-3 float-left text-light"></i>
                <div class="h5 text-info mb-0 pt-3"><?=count($dashboardTodayOrders)?></div>
                <div class="text-muted text-uppercase font-weight-bold font-xs small"> Programs</div>
            </div>
        </div>
    </div>
    </a>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="card">
            <div class="p-0 clearfix">
                <i class="fas fa-university bg-primary p-4 font-2xl mr-3 float-left text-light"></i>
                <?php
                    $totalSale = 0;
                    $totalDiscount = 0;
                ...
                <div class="text-muted text-uppercase font-weight-bold font-xs small"> Departments</div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="card">
            <div class="p-0 clearfix">
                <i class="fas fa-graduation-cap bg-success p-4 font-2xl mr-3 float-left text-light"></i>
                <?php
                    $totalExpenses = 0;
                ...
                ?>
                <div class="h5 text-success mb-0 pt-3"><?=$totalExpenses?></div>
                <div class="text-muted text-uppercase font-weight-bold font-xs small">Courses</div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="card">
            <div class="p-0 clearfix">
                <i class="fas fa-user-graduate bg-danger p-4 font-2xl mr-3 float-left text-light"></i>
                <?php 
                    $profit = $totalWithoutDiscount - $totalExpenses;
                ?>
                <div class="h5 text-danger mb-0 pt-3"><?=$profit?></div>
                <div class="text-muted text-uppercase font-weight-bold font-xs small">Students</div>
            </div>
        </div>
    </div>
                    ...
                    <div class="stat-widget-four">
                        ...
                        <div class="stat-content">
                            <div class="text-left dib">
                                <div class="stat-heading">Sections</div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="stat-widget-four">
                        ...
                        <div class="stat-content">
                            <div class="text-left dib">
                                <div class="stat-heading">Staff</div>
