...
<div class="modal fade" id="makeReservationModal" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
    ...
    <script src="<?=ADMIN_JS?>jspdf.min.js"></script>
    <script src="<?=ADMIN_JS?>main.js"></script>
    <script src="<?=ADMIN_VENDOR?>chart.js/dist/Chart.bundle.min.js"></script>
     <script src="<?=ADMIN_JS?>dashboard.js"></script>
    <script src="<?=ADMIN_JS?>widgets.js"></script>
    <script src="<?=ADMIN_VENDOR?>jqvmap/dist/jquery.vmap.min.js"></script>
    <script src="<?=ADMIN_VENDOR?>jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
    <script src="<?=ADMIN_VENDOR?>jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script>
