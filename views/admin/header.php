    ...
    <aside id="left-panel" class="left-panel" style="background-color:  #fff !important;">
        <nav class="navbar navbar-expand-sm">
            ...
            <div class="navbar-header" style="background-color:  #fff !important;">
                ...
                <a class="navbar-brand" href="./"><img src="<?=ADMIN_IMG?>logo-n.png" style="width:24px;" alt="Logo"> &nbsp;&nbsp;<b>GCW</b> Model Town</a>
                <a class="navbar-brand hidden" href="./"><img src="<?=ADMIN_IMG?>logo2.png" alt="Logo"></a>
            </div>
            ...
            <br><br><br><br><br><br><br><br><br><br><br>
                ...
                <?php if(isset($_SESSION['login_admin'])){ ?>
                    <ul class="nav navbar-nav">
                        <li class="">
                            <a href="adminDash"><i class="menu-icon fab fa-product-hunt"></i> Programs </a>
                        </li>
                        <li class="">
                            <a href="addOwner"><i class="menu-icon fas fa-university"></i> Departments </a>
                        </li>
                        <li class="">
                            <a href="owners"><i class="menu-icon fas fa-graduation-cap"></i> Courses</a>
                        </li>
                        <li class="">
                            <a href="addStudents"><i class="menu-icon fas fa-user-graduate"></i> Add Students</a>
                        </li>
                    </ul>
                <?php } ?>
            </div><!-- /.navbar-collapse -->
    ...
    <div class="col-sm-5">
        ...
        <div class="user-area dropdown float-right">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="user-avatar rounded-circle" src="<?=ADMIN_IMG?>owners/admin.png" alt="User Avatar">
            </a>
